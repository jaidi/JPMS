...
(function(a) {
	...
	a
			.extend(
					a.jqx._jqxDropDownList.prototype,
					{
						...
						render : function() {
							...
							this.dropdownlistContent
									.addClass(this
											.toThemeProperty("jqx-dropdownlist-content"));
							this.dropdownlistWrapper.addClass(this
									.toThemeProperty("jqx-disableselect"));
							this.addHandler(this.dropdownlistWrapper,
							...
							this.dropdownlistContent[0].id = "dropdownlistContent"
									+ this.element.id;
							var j = this.toThemeProperty("jqx-widget")
									+ " "
									+ this
											.toThemeProperty("jqx-widget-content")
									+ " "
									+ this
											.toThemeProperty("jqx-dropdownlist-state-normal")
									+ " "
							...
							try {
								...
								var b = a("<div style='overflow: hidden; background-color: transparent; border: none; position: absolute;' id='listBox"
										+ this.id
										+ "'><div id='innerListBox"
										+ this.id + "'></div></div>");
								b.hide();
								...
								this.listBoxContainer
										.jqxListBox( {
											...
											theme : this.theme,
											rendered : function() {
												if (h.selectedIndex != h.listBoxContainer
														.jqxListBox("selectedIndex")) {
													h.listBox = a
															.data(
																	h.listBoxContainer[0],
																	"jqxListBox").instance;
													h.listBoxContainer
															.jqxListBox( {
							...
							this.propertyChangeMap.disabled = function(e, n, m,
								...
								if (o) {
									e.host
											.addClass(l
													.toThemeProperty("jqx-dropdownlist-state-disabled"));
									e.host
											.addClass(l
													.toThemeProperty("jqx-fill-state-disabled"));
									e.dropdownlistContent
											.addClass(l
													.toThemeProperty("jqx-dropdownlist-content-disabled"))
								} else {
									e.host
											.removeClass(l
													.toThemeProperty("jqx-dropdownlist-state-disabled"));
							...
							if (a.browser.msie && a.browser.version < 8) {
								if (this.host.parents(".jqx-window").length > 0) {
									var i = this.host.parents(".jqx-window")
											.css("z-index");
									b.css("z-index", i + 10);
									this.listBoxContainer
											.css("z-index", i + 10)
						...
						_addInput : function() {
							...
							this.input.attr("name","ddList_"+b);
							this.input.attr("id","ddList_"+b);
						},
						getItems : function() {
							if (!this.listBox) {
								return new Array()
						...
						_updateHandlers : function() {
										...
										.hover(
												function() {
													if (!c.disabled
														...
														c.host
																.addClass(c
																		.toThemeProperty("jqx-dropdownlist-state-hover"));
														c.arrow
																.addClass(c
							...
							if (this.touch) {
								...
								this.addHandler(a(document), "mousedown."
										+ this.id, c.closeOpenedListBox, {
									me : this,
									listbox : this.listBox,
									id : this.id
												...
												if (g.keyCode == "27") {
													if (!c.ishiding) {
														...
														if (c.tempSelectedIndex != undefined) {
															c
																	.selectIndex(c.tempSelectedIndex)
														}
													}
												}
												if (f && !c.disabled) {
														...
														c
																._raiseEvent(
																		"2",
																		{
																			...
																			type : f.args.type,
																			item : f.args.item,
																			originalEvent : f.args.originalEvent
																		});
							...
							this
									.addHandler(
											...
											function() {
												c.host
														.addClass(c
																.toThemeProperty("jqx-dropdownlist-state-focus"));
												c.host
														.addClass(c
						...
						removeHandlers : function() {
							...
							if (this.listBox) {
								if (this.listBox.content) {
									this.removeHandler(this.listBox.content,
											"click")
								}
							}
							...
							a(document).unbind("mousemove." + c.id)
						},
						getItem : function(b) {
						...
						renderSelection : function() {
							...
							var p = this.listBox.visibleItems[this.listBox.selectedIndex];
							var m = this;
							if (this.checkboxes) {
							...
							if (p == null) {
								...
								d
										.addClass(this
												.toThemeProperty("jqx-listitem-state-normal"));
								d.addClass(this.toThemeProperty("jqx-item"));
								d.html(this.promptText);
								var c = this.dropdownlistContent
										.css("padding-top");
								var q = this.dropdownlistContent
										.css("padding-bottom");
								d.css("padding-top", c);
								d.css("padding-bottom", q);
								var b = d.outerHeight();
								d.remove();
								d.removeClass();
								...
								if (this.height != null
									...
									o = parseInt(this.height)
								}
								var n = parseInt((parseInt(o) - parseInt(b)) / 2);
								if (n > 0) {
									this.dropdownlistContent.css("margin-top",
											n + "px");
									this.dropdownlistContent.css(
											"margin-bottom", n + "px")
								}
								if (this.selectionRenderer) {
									this.dropdownlistContent.html(this
											.selectionRenderer());
							...
							try {
								if (p.html != undefined && p.html != null
										&& p.html.toString().length > 0) {
									d.html(p.html)
								} else {
									if (p.label != undefined && p.label != null
											&& p.label.toString().length > 0) {
										d.html(p.label)
									} else {
							...
							if (this.selectionRenderer) {
								this.dropdownlistContent.html(this
										.selectionRenderer(d, p.index, p.label,
												p.value))
							} else {
								if (this.checkboxes) {
									var j = this.getCheckedItems();
									var k = "";
							...
							var n = parseInt((parseInt(o) - parseInt(b)) / 2);
							if (n > 0) {
								this.dropdownlistContent.css("margin-top", n
										+ "px");
								this.dropdownlistContent.css("margin-bottom", n
										+ "px")
							}
						...
						_updateInputSelection : function() {
							if (this.input) {
								if (this.selectedIndex == -1) {
									...
									if (d != null) {
										this.input.val(d.value)
									} else {
										this.input.val(this.dropdownlistContent
												.text())
									}
								}
								if (this.checkboxes) {
						...
						showListBox : function() {
							...
							this.host
									.addClass(this
											.toThemeProperty("jqx-dropdownlist-state-selected"));
							...
							if (this.animationType == "none") {
								...
								a.data(document.body, "openedJQXListBoxParent",
										p);
								a.data(document.body, "openedJQXListBox"
										+ this.id, e);
								e.css("margin-top", 0);
								e.css("opacity", 1)
							} else {
								...
								if (this.animationType == "fade") {
									...
									e.animate( {
										...
										a.data(document.body,
												"openedJQXListBoxParent", p);
										a.data(document.body,
												"openedJQXListBox" + p.id, e);
										p.ishiding = false;
										p.isanimating = false
									})
								} else {
						...
						hideListBox : function() {
							...
							var d = this;
							a.data(document.body, "openedJQXListBox" + this.id,
									null);
							if (this.animationType == "none") {
								this.container.css("display", "none")
							} else {
						...
						propertyChangedHandler : function(b, c, f, e) {
							...
							if (c == "theme" && e != null) {
								...
								b.dropdownlistWrapper.addClass(b
										.toThemeProperty("jqx-disableselect"));
								b.host.removeClass();
								b.host
										.addClass(b
