            ...
            <div id="customWindow">
                <div id="customWindowContent" style="overflow: hidden; width:100%;">
                    <div style="margin: 10px; float:left; width: 25% auto">
                    	<?php 
							if (isset($operation) && $operation !=null){ ?>
                        ...
                        <input class="cInput" type="text" size="20" id="bed_number" name="bed_number"  value="<?php echo $operation->almoner_number; ?>" />
						<br/><br/>
						...
						<textarea class="cInputArea" rows="5" cols="50" size="256" id="operation" name="operation" >
						...
						<textarea class="cInputArea" rows="5" cols="50" size="256" id="findings" name="findings" >
							<?php echo $operation->findings; ?>
						</textarea>
                        <br/><br/>						
						<label class="cLabel" for="procedure">Procedure:</label>
						<textarea class="cInputArea" rows="5" cols="50" size="256" id="procedure" name="procedure" >
							<?php echo $operation->procedure; ?>
						</textarea>
                        <br/><br/>						
						<label class="cLabel" for="closure">Closure:</label>
						<textarea class="cInputArea" rows="5" cols="50" size="256" id="closure" name="closure" >
							<?php echo $operation->closure; ?>
						</textarea>
                        <br/><br/>						
