    ...
    <div id='content'>
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#jqxDropDownList").jqxDropDownList({ source: source, selectedIndex: 0, width: '200', height: '25', theme: theme });
                $('#AutoComplete').jqxCheckBox({ width: '120px', theme: theme });
                $('#Enabled').jqxCheckBox({ checked: true, width: '120px', theme: theme });
                $('#Open').jqxButton({ width: 80, theme: theme });
                $('#Close').jqxButton({ width: 80, theme: theme });
                $('#Settings').jqxExpander({ showArrow: false, toggleMode: 'none', theme: theme });
                $('#Open').click(function () {
                    // show popup.
                ...
                $('#Enabled').bind('change', function (event) {
                    // enable or disable.
                    var checked = !event.args.checked;
                    $("#jqxComboBox").jqxComboBox({ disabled: checked });
                });
                $('#AutoComplete').bind('change', function (event) {
